#   Description:
# This script will disable most of the privacy settings in windows 10
# I am not responsible for any damage caused by this script [like it could do any damage lol]
...
Write-Output "general privacy"
# "Let websites provide relevant content by accessing my language list"
...
Write-Output "Do not send contact informations"
...
Write-Output "Disable location detector"
